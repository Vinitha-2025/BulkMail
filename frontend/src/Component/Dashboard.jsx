...
function Dashboard(){
  ...
  if(savedEmail){
    axios.get("http://localhost:3000/user/"+savedEmail)
    .then(function(data){
  ...
  function send(){
    setStatus(true)
    axios.post("http://localhost:3000/sendemail",{msg:msg, emailList:emailList, subject:subject, emailTo:emailTo})
    .then(function(data){
      if(data.data === true){
        setStatus(false)
        setSuccess(true)
...
//   {/* CLOSE MENU BUTTON */}
//   <button onClick={()=>{setSidebar(false)}}
//     className="md:hidden absolute top-4 right-4 text-xl text-white">
//     <i className="fa-solid fa-xmark"></i>
//   </button>
...
//     {/* NAVIGATION */}
//     <div className="flex-1 px-4 mt-6">
//       <div className=" w-full flex items-center gap-3 px-4 py-3 rounded-lg border border-blue-200 hover:bg-blue-700 hover:text-white">
//         <i className="fa-solid fa-house"></i>
//         <span>Dashboard</span>
//       </div>

//       <div className="w-full flex items-center gap-3 px-4 py-3 mt-2 rounded-lg border border-blue-200 hover:bg-blue-700 hover:text-white">
//         <i className="fa-solid fa-clock-rotate-left"></i>
//         <span>Email History</span>
//       </div>
...
//         </div>
//         <div className="min-w-0">
//           <p className="font-semibold truncate">Vinitha </p>
//           <p className="text-xs text-blue-700 truncate">vinitha@gmail.com</p>
//         </div>
//         <div className="text-xs">
//           <span className="cursor-pointer hover:text-blue-700"> Sign Out</span>
//         </div>
//       </div>
//     </div>
//   </div>
...
//   {/* EMAIL CARD */}
//   <div className="w-full md:ml-64 p-4 sm:p-6 md:p-8 ">
...
// export default Dashboard
    ...
    {/* STATUS CARDS */}
    {/* <div className=" grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mt-6 ">
